...
impl GgmlType {
    ...
    pub fn byte_size(&self, n: usize) -> usize {
        match self {
            Self::F32  => n*4,  Self::F16  => n*2,
            Self::Q4_0 => n/32*18, Self::Q4_1 => n/32*20,
            Self::Q5_0 => n/32*22, Self::Q5_1 => n/32*24,
            Self::Q8_0 => n/32*34, Self::Q8_1 => n/32*36,
            Self::Q2K  => n/256*84,  Self::Q3K  => n/256*110,
            Self::Q4K  => n/256*144, Self::Q5K  => n/256*176,
            Self::Q6K  => n/256*210, Self::Q8K  => n/256*292,
        }
    }
}
...
pub struct TensorInfo {
    pub name: String, pub dims: Vec<u64>,
    pub typ: GgmlType, pub offset: u64,
}
impl TensorInfo {
